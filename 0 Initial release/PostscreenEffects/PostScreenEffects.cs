...
namespace PostscreenEffects
{
    public class PostScreenFilters
    {
            ...
            ContentManager Content )
        {
            ...
            //_RenderTarget = new RenderTarget2D( _Device,
            //    Width,
            //    Height,
            //    1,
            ...
            float Exposure )
        {
            ...
            //System.IO.FileStream stream = System.IO.File.Create("LightShafts.png");
            //RenderTargetMask.SaveAsPng(stream, RenderTargetMask.Width, RenderTargetMask.Height);
            //stream.Close();
//            _Device.Textures[ 0 ] = RenderTargetMask;
            Effect effect = _LightShafts;
            effect.CurrentTechnique = effect.Techniques[ 0 ];
            //            effect.Parameters["TextureMask"].SetValue(RenderTargetMask);
            ...
            foreach ( EffectPass pass in effect.CurrentTechnique.Passes )
            {
              ...
              //effect.End( );
            //System.IO.FileStream stream = System.IO.File.Create("RenderTargetMask.png");
            //RenderTargetMask.SaveAsPng(stream, RenderTargetMask.Width, RenderTargetMask.Height);
            //stream.Close();
            //stream = System.IO.File.Create("LightShafts.png");
            //Destination.SaveAsPng(stream, Destination.Width, Destination.Height);
            //stream.Close();
            _Device.SetRenderTarget( null );
        }
        // ---------------------------------------------------------
            ...
            float ScaleFactor )
        {
            ...
            //effect.End( );
            //System.IO.FileStream stream = System.IO.File.Create("ExtractHighLuminance.png");
            //Destination.SaveAsPng(stream, Destination.Width, Destination.Height);
            //stream.Close();
            //stream = System.IO.File.Create("ExtractHighLuminance_src.png");
